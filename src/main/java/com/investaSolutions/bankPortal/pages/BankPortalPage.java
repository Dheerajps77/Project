...
public class BankPortalPage {
	...
	public boolean verifyBankPortalPageDetails(String dashboardTab, String settingsTab, String instrumentsTab, String modelsTab, String rebalanceTab, String riskTab, String usersTab, String disconnectTab) throws Exception{
		boolean flag = false;
		try {
			...
			if(dashboardTextFromUI.equals(dashboardTab) && settingsTextFromUI.equals(settingsTab) && instrumentsTextFromUI.equals(instrumentsTab) && modelsTextFromUI.equals(modelsTab) && rebalanceTextFromUI.equals(rebalanceTab) && riskTextFromUI.equals(riskTab) && usersTextFromUI.equals(usersTab) && disconnectTextFromUI.equals(disconnectTab)){
				flag = true;
				TestBase.logInfo(String.format(properties.getLogMessage("BankPortalPageDetailsVerified"), dashboardTab, settingsTab, instrumentsTab, modelsTab, rebalanceTab, riskTab, usersTab, disconnectTab, 
						dashboardTextFromUI, settingsTextFromUI, instrumentsTextFromUI, modelsTextFromUI, rebalanceTextFromUI, riskTextFromUI, usersTextFromUI, disconnectTextFromUI));
				return flag;
			}
		} catch (Exception e) {
			throw e;
